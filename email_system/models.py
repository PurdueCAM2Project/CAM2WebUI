...
class JoinModel(models.Model):
    name=models.CharField(verbose_name='Name', max_length=100, blank=True, null=True)
    from_email=models.EmailField()
    major=models.CharField(verbose_name='Major', max_length=500, blank=True, null=True)
    gradDate=models.CharField(verbose_name='Graduation Date', max_length=500, blank=True, null=True)
    courses=models.CharField(verbose_name='Courses Taken', max_length=500, blank=True, null=True)
    languages=models.CharField(verbose_name='Programming Languages', max_length=500, blank=True, null=True)
