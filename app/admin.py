...
from .models import Homepage, FAQ, History, Publication, Team, Leader, TeamMember, RegisterUser, Collab, Location, Sponsor, Poster, ReportedCamera, Calendar, Video, Subteam, Member
from django.contrib import admin
