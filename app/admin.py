...
from .models import Homepage, FAQ, History, Publication, Team, Leader, Member,RegisterUser, Collab, Location, Sponsor, Poster, ReportedCamera, Calendar, Subteam, Video
from django.contrib import admin
